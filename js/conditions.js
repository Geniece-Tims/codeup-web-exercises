...
let inputColor =  prompt("Input color here");
...
let totalBill = prompt("Please enter a total amount for your bill");
...
function numberInfo() {
    ...
    if(confirm("Would you like to enter a number?")) {
        ...
        if(isNaN(userInput)){
            ...
            alert("You've entered an input that is not a number. Please try again.");
        }
    }
